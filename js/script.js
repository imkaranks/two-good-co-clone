(function () {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "Felicity T",
      review:
        "The hampers we ordered were lovely and the team are wonderful to liase with.",
    },
    {
      id: "m// 003",
      name: "Barbara",
      review:
        "My package just arrived and the presentation is so beautiful; elegant, magical and meaningful, with the items wrapped in delicious-smelling tissue paper. Georgeous; Will be back for more.",
    },
    {
      id: "m// 004",
      name: "Salesforce",
      review:
        "I think I speak for everyone when I say we are very grateful to have been able to come in and help out for the day; The work you do is amazing.",
    },
    {
      id: "m// 005",
      name: "Cartier",
  ...
  new Swiper(".testimonial__authors", {
    slidesPerView: "auto",
    spaceBetween: 50,
    loop: true,
    // speed: 1000,
  ...
  function loadTestimonials() {
    ...
    testimonials.forEach((testimonial, i) => {
      clutter += `
        <div class="testimonial__author swiper-slide">
          <input type="radio" name="author" id="${testimonial.id}" ${
        i == 0 ? "checked" : ""
      }>
    ...
    document.querySelector(".testimonial__authors .swiper-wrapper").innerHTML =
      clutter;
  }
  ...
  [
    [".products__card", ".products"],
    [".featured__item", ".featured"],
    [".footer__item svg > path", ".footer__wrapper"],
    [".impact .scroll-img-wrapper", ".impact"],
  ].forEach(([elem, target]) => cardTransition(elem, target));
  ...
  [".featured__wrapper", ".testimonial__wrapper", ".footer"].forEach(
    ($section) => sectionTitleTransition($section)
  );
